...
function socialsharingSMSDemo() {
  console.log(window.plugins.socialsharing.available);
  console.log(window.plugins.socialsharing);
  window.plugins.socialsharing.shareViaSMS("message", "97213779", function(){alert("ok")}, function(e){alert("error: " + e)});
}
